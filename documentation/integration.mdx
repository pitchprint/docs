...
<CardGroup cols={2}>
  ...
  <Card title="Generate your auth keys" icon="key" href="/documentation/generate-your-auth-keys">
    Create the API and Secret keys needed to integrate the app.
  </Card>
  <Card title="After Save" icon="floppy-disk" href="/documentation/after-save">
    Handle the project-saved event and use the returned data.
  </Card>
  <Card title="My Account - Saved Projects" icon="user" href="/documentation/custom-integration-my-account">
