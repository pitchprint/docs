...
but you may display such a message as well if you wish to incase our message is not clear enough, You can do so by inserting the following code in the custom javascript section on the PitchPrint [Admin Settings](/tutorial/admin-settings) page:
