...
This can be accessed easily via the designer once it has been  [instantiated as described here](/api-reference/integration#initialize).
...
> If you are on any of our frameworks, you can use the  [designer ready method to hook your events](/api-reference/designer-ready-method)
