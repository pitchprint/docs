...
description: "Create alternative app layouts and link them to designs with shared tags, so different products open with different tool sets."
---
...
<Steps>
  ...
  <Step title="Add a new layout">
    Then create a new Layout by clicking the **_Add New Layout_** button.
  </Step>
  ...
  <Step title="Click Assign to..">
    You should find the red **_Assign to.._** button:
