---
title: "Integration"
description: "Build a working PitchPrint page from scratch: load the client script, initialize it with your API key and design ID, and handle its events."
---
...
<Tip>
  The code you are about to create can be downloaded here: [sample SDK index.html on GitHub](https://github.com/pitchprint/pitchprint/blob/master/sdk/index.html)
</Tip>
...
To test, click the Launch Designer button. And your designer should show like this. If not, please open a ticket and let us know. ![The designer opened from the Launch Designer button](https://s3.amazonaws.com/helpscout.net/docs/assets/58f1ec6d2c7d3a52b42f8254/images/61a5f2ccefc78d0553e5eaca/file-0sKRATHNyv.png)
...
<Frame>
  <img src="https://s3.amazonaws.com/helpscout.net/docs/assets/58f1ec6d2c7d3a52b42f8254/images/629db8e8a2c316231c203063/file-d9nBJgLEd1.png" alt="History tab of a design's configuration, showing where the designId appears" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Introduction" icon="circle-info" href="/docs/api-reference/introduction">
    Overview of what PitchPrint is and how it works.
  </Card>
  <Card title="Generate your auth keys" icon="key" href="/docs/api-reference/generate-your-auth-keys">
    Create the API and Secret keys needed to integrate the app.
  </Card>
  <Card title="After Save" icon="floppy-disk" href="/docs/api-reference/after-save">
    Handle the project-saved event and use the returned data.
  </Card>
  <Card title="My Account - Saved Projects" icon="user" href="/docs/api-reference/custom-integration-my-account">
