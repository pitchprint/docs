...
<Tip>
  If you are on any of the cart frameworks, you can use the; [designer ready method to hook your events](/docs/api-reference/designer-ready-method)
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Initialization Options" icon="sliders" href="/docs/api-reference/initialization-options">
