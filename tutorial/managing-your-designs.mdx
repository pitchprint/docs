...
-   **Tags**: Here you can add tags which will allow you to assign a layout to a design please have a look at the following [document](/tutorial/layouts-v10) to learn more about layouts and tags. 
...
-   **Image DPI Check:** This is where you set DPI limit for any picture your users can add to the canvas. For this design, this value overrides the one you might have set on the settings page. Please read more [here to learn more about DPI Check](/tutorial/photo-resolution-check)
-   **New Text Color:** Here, you get to set the default color of any text created by the user while editing this design. You can supply the RGB and CMYK values. To read more about colors, [please click here](/tutorial/all-about-colors)
...
Here, you will manage and assign modules to each design. Please read more about individual [modules here](/documentation/data-form-module)
