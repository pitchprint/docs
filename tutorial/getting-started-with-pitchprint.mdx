...
description: "This article will give you an overview of PitchPrint, outlining its features, user cases, workflows and general best practices. We advise every new customer ..."
---
...
-   **Install PitchPrint plugin on your website**. Here are links to Install the plugin on your store based on the Framework you have on your current site: [WordPress + WooCommerce](https://docs.pitchprint.com/article/35-how-to-install-pitchprint-on-wordpress), [OpenCart](https://docs.pitchprint.com/article/26-how-to-install-pitchprint-on-opencart), [PrestaShop](https://docs.pitchprint.com/article/36-how-to-install-pitchprint-on-prestashop), [Shopify](https://docs.pitchprint.com/article/37-pitchprint-for-shopify-getting-started), [Magento](https://docs.pitchprint.com/article/113-magento-installation), 3DCart or a [Custom Site](https://docs.pitchprint.com/article/88-integration)
    If you do not have a site yet, you can [read this article to make a decision on which to pick](https://docs.pitchprint.com/article/44-which-framework-should-i-pick).
