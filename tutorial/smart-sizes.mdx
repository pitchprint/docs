...
<Frame>
  <img src="/images/image-2.png" alt="Smart Sizes enabled on a page with the plus sign for adding a new size" />
</Frame>
...
<Frame>
  <img src="/images/Group-83.png" alt="In-app panel where customers choose between the available design layouts" />
</Frame>
...
<Frame>
  <img src="/images/Screen-Shot-2021-09-20-at-13.25.45.png" alt="Smart Canvas option in the left panel of the design editor with the plus icon for adding a smart page" />
</Frame>
...
<Frame>
  <img src="/images/image-3.png" alt="Layouts page in the admin with the option to update to the latest layout" />
</Frame>
