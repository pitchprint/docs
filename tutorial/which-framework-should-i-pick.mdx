...
<CardGroup cols={2}>
  ...
  <Card title="How To Install PitchPrint On WordPress" icon="wordpress" href="/tutorial/how-to-install-pitchprint-on-wordpress">
    Step-by-step guide to installing PitchPrint on WordPress with WooCommerce.
  </Card>
  <Card title="PitchPrint For Shopify.. Getting Started" icon="shopify" href="/tutorial/pitchprint-for-shopify-getting-started">
    Get started installing and using PitchPrint on your Shopify store.
  </Card>
</CardGroup>
