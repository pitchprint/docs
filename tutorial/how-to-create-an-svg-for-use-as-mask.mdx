...
description: "Flatten artwork into a single compound path in Illustrator and save it as an SVG that PitchPrint accepts as a photo mask."
---
...
<Frame>
  <img src="https://s3.amazonaws.com/helpscout.net/docs/assets/58f1ec6d2c7d3a52b42f8254/images/599ea7ec042863033a1c407c/file-wOatBgdUSk.png" alt="SVG source code showing a single path element directly inside the svg node" />
</Frame>

<Steps>
  <Step title="Convert the shape into a path">
  ...
  <Step title="Make a compound path">
    Select them and click **Object > Compound Path > Make**.
  </Step>

  <Step title="Save the file as SVG">
  ...
  <Step title="Import the SVG into PitchPrint">
