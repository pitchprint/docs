...
<ResponseField name="Mask mode" type="toggle">
  ...
  Think of it as a Photo Print feature where customers can order photo prints in standard sizes by placing their photos on the canvas and have it fit that dimension. When they choose a different dimension, the photo will adjust to fit the new size.
</ResponseField>
