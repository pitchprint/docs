...
description: "Automatically open the editor with the design that matches the variable options, such as material and size, that a customer selects."
---
...
<Steps>
  ...
  <Step title="Enable the module and add selectors">
    ...
    <Frame>
      <img src="https://s3.amazonaws.com/helpscout.net/docs/assets/58f1ec6d2c7d3a52b42f8254/images/609d189445543f49ed69b1aa/file-NyzS0dJYzL.png" alt="Design Observables module settings with variable option selectors listed in order" />
    </Frame>
  </Step>
  <Step title="Assign the category to your product">
