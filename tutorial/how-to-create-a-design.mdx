...
> **NOTE:** Before creating your design, it is imperative you understand the type of designs you can create on PitchPrint.  [You can read that here](/tutorial/types-of-pitchprint-designs).
...
**Include in Form:** Set this to Yes if you want this item to be included in the preset form or the new [Data Form module](/documentation/data-form-module)
