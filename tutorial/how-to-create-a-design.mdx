...
description: "A PitchPrint design is simply a file containing a combination of shapes, texts or pictures in the form of a template that customers can easily modify with li..."
---
...
> **NOTE:** Before creating your design, it is imperative you understand the type of designs you can create on PitchPrint.  [You can read that here](http://docs.pitchprint.com/article/58-types-of-pitchprint-designs).
...
To get started, navigate to the designs section of the admin: [https://admin.pitchprint.io/designs](https://admin.pitchprint.io/designs)
...
![](https://s3.amazonaws.com/helpscout.net/docs/assets/58f1ec6d2c7d3a52b42f8254/images/6035ffd9b3ebfb109b5857d5/file-qPbiFrAx6c.png)
...
![](https://s3.amazonaws.com/helpscout.net/docs/assets/58f1ec6d2c7d3a52b42f8254/images/61af03438564e0276362a114/file-LNBxHJeRPC.png)
...
You can now click the “Add Page” button to create your page. The page thumbnail image is used in modules that needs to show the product image during design selection, so you can ignore it for now. You can learn more about the other [options here](https://docs.pitchprint.com/article/58-types-of-pitchprint-designs).
...
![](https://s3.amazonaws.com/helpscout.net/docs/assets/58f1ec6d2c7d3a52b42f8254/images/61af03877a3b8c03913d4892/file-9558YcgeQO.png)
...
![](https://s3.amazonaws.com/helpscout.net/docs/assets/58f1ec6d2c7d3a52b42f8254/images/61af039f7a3b8c03913d4893/file-1HqMpFSQ8B.png)
...
![](https://s3.amazonaws.com/helpscout.net/docs/assets/58f1ec6d2c7d3a52b42f8254/images/61af03bccec96836600b73b3/file-tZ3bGxwa27.png)
...
![](https://s3.amazonaws.com/helpscout.net/docs/assets/58f1ec6d2c7d3a52b42f8254/images/61af03ff48287b4578809790/file-do1K21PjJP.png)
...
**Include in Form:** Set this to Yes if you want this item to be included in the preset form or the new [Data Form module](http://docs.pitchprint.com/article/40-data-form-module)
...
You can read more about [Text Styles here](https://docs.pitchprint.com/article/47-text-styles/)
